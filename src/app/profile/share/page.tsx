...
function SharePageContent() {
    ...
    const isLoading = isUserLoading || isProfileLoading || playersLoading || tierSettingsLoading;
    ...
    return (
        <div className="p-2 sm:p-6 lg:p-8">
            <div className="max-w-md mx-auto space-y-6">
                <Card>
                    <CardHeader>
                        <CardTitle className="font-headline text-2xl">Your Shareable Card</CardTitle>
                        <CardDescription>Your dynamic image is ready. Download it or copy the text to share on social media.</CardDescription>
                    </CardHeader>
                    <CardContent>

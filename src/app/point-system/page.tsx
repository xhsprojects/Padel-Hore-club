...
import { Flame, ShieldCheck, Star, Trophy, Users, Award, Clock, RefreshCw } from 'lucide-react';
                                ...
                                <div className="space-y-4 py-3 text-sm">
                                    ...
                                    <div>
                                        ...
                                        <ul className="list-disc space-y-1 pl-5 pt-2 text-muted-foreground">
                                            <li><span className="font-semibold text-foreground">Legend:</span> 35%</li>
                                            <li><span className="font-semibold text-foreground">Elite:</span> 30%</li>
                                            <li><span className="font-semibold text-foreground">Challenger:</span> 25%</li>
                                            <li><span className="font-semibold text-foreground">Regular:</span> 20%</li>
                                            <li><span className="font-semibold text-foreground">Rookie:</span> 20%</li>
                                        </ul>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-muted-foreground">
                                            Seorang pemain di tier <strong className="text-foreground">Elite</strong> menyelesaikan musim dengan 800 poin. Poin musim barunya akan menjadi (800 × 30%) + 601 (poin dasar Elite) = 240 + 601 = <strong>841 poin</strong>.
                                        </p>
                                    </div>
                                </div>
                            </PointCategory>

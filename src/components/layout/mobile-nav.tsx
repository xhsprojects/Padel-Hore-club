...
import { BarChart3, QrCode, Plus, LayoutGrid, User, LogIn, Calendar, Swords, Store, Award } from 'lucide-react';
...
export function MobileNav() {
    ...
    const fabItem = isAdmin 
        ? { href: '/admin/event-matches', icon: Swords, label: 'Event Match' } 

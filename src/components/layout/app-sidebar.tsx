    ...
    <>
      <Sidebar collapsible="icon">
          ...
          <SidebarMenu className="p-2">
            ...
            {isUserLoading || (user && isProfileLoading) ? (
              ...
              <SidebarGroup>
                  ...
                  <SidebarGroupContent>
                    <SidebarMenuItem>
                        <SidebarMenuButton asChild isActive={pathname === '/admin/scanner'} tooltip={{ children: 'Scan Match' }} suppressHydrationWarning >
                            <Link href="/admin/scanner" onClick={handleLinkClick}><QrCode /><span>Scan Match</span></Link>
                        </SidebarMenuButton>
                    </SidebarMenuItem>
                    <SidebarMenuItem>
        ...
        <SidebarFooter className="flex flex-col gap-2 p-2 mt-auto">
          ...
          <SidebarMenu className="p-0">
            <SidebarMenuItem>
                <SidebarMenuButton onClick={toggleSidebar} variant="ghost" className="w-full justify-start">
